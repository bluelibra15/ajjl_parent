...
public class QiniuUtils {
    ...
    static String accessKey = "TdrCdSksLMBTvE2dEvzG7kdNcxP2JH1RMhRa2f0C";
    static  String secretKey = "XRNzNcS8Me4y_CucX1dO2DGaj73ODqqNMVa7jSBT";
    static String bucket = "meinian-wujunjie";
